...
export const NoticeTicker = memo(({ previewText, previewEnabled, isPreview = false }) => {
  ...
  return (
    <div
      className="group relative w-full bg-gradient-to-r from-amber-600 via-orange-600 to-primary-700 text-white shadow-xs border-b border-white/10 select-none overflow-hidden z-20"
      role="region"
    ...
    >
      <div className="flex items-center w-full min-h-[36px] sm:min-h-[38px]">
        ...
        <div className="shrink-0 z-10 flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 bg-black/30 backdrop-blur-xs border-r border-white/15 text-[11px] sm:text-xs font-black uppercase tracking-wider shadow-sm">
          ...
          <span className="hidden sm:inline font-extrabold tracking-wide text-amber-100">
            NOTICE
          </span>
          <span className="sm:hidden font-extrabold tracking-wide text-amber-100">
            NOTICE
          </span>
        </div>
        ...
        <div className="relative flex-1 overflow-hidden flex items-center py-1.5 cursor-default">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-4 sm:w-8 bg-gradient-to-r from-black/15 to-transparent pointer-events-none z-1" />
          <div className="absolute right-0 top-0 bottom-0 w-4 sm:w-8 bg-gradient-to-l from-black/15 to-transparent pointer-events-none z-1" />
