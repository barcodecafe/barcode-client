              ...
              return (
                ...
                >
                  ...
                  <div
                    ...
                    className="py-2 px-3 sm:py-2.5 sm:px-3.5 cursor-pointer hover:bg-neutral-50 dark:hover:bg-neutral-800/40 transition-colors"
                  >
                    {/* DESKTOP / LAPTOP VIEW (md:flex): Single horizontal row matching Image 1 & 2 */}
                      ...
                      <div className="flex items-center gap-2 sm:gap-4 text-[10px]">
                        ...
                        {log.rejected > 0 && (
                          <div>
                            ...
                            <span className="inline-flex items-center gap-0.5 font-bold text-red-500 text-[10px]">
                        ...
                        <div className="text-right">
                          {log.delivered === 0 ? (
                            ...
                            <button
                              ...
                              className="inline-flex items-center gap-1 text-[9px] font-bold text-white bg-amber-500 hover:bg-amber-600 px-2 py-0.5 rounded-lg transition-all active:scale-95 cursor-pointer disabled:opacity-50 whitespace-nowrap"
                            >
                    ...
                    {/* MOBILE VIEW (md:hidden): Compact 2-part card */}
                    <div className="md:hidden space-y-2">
                      ...
                      <div className="grid grid-cols-4 gap-1 pt-2 border-t border-neutral-100 dark:border-neutral-800/60 text-center">
                              ...
                              >
                                ...
                                <div className="flex items-center gap-1.5 min-w-0 flex-1 flex-wrap sm:flex-nowrap">
                                  ...
                                  <div className="flex items-center gap-1 min-w-0 flex-1">
                                    ...
                                    <div
                                      className="flex items-center gap-0.5 text-neutral-500 dark:text-neutral-400 text-[9px] sm:text-[10px] truncate min-w-0"
                                ...
                                <div className="shrink-0 flex items-center">
                                  {isRejected ? (
                                    ...
                                    <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-md bg-purple-50 dark:bg-purple-950/40 border border-purple-200/70 dark:border-purple-900/40 text-purple-700 dark:text-purple-300 text-[8px] sm:text-[9px] font-bold">
                                      <CreditCard className="w-2.5 h-2.5 text-purple-600" />
                                      <span>Online Paid</span>
                                    </span>
                                  ) : isOrderSettledByAdmin ? (
                                    <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-md bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-300 dark:border-emerald-800 text-emerald-800 dark:text-emerald-200 text-[8px] sm:text-[9px] font-bold">
                                      <CheckCircle2 className="w-2.5 h-2.5 text-emerald-600 dark:text-emerald-400" />
                                      <span>Paid to Admin ✓</span>
                                    </span>
                                  ) : isOrderSubmittedToAdmin ? (
                                    <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-md bg-blue-50 dark:bg-blue-950/40 border border-blue-200/70 dark:border-blue-900/40 text-blue-700 dark:text-blue-300 text-[8px] sm:text-[9px] font-bold">
                                      <Clock3 className="w-2.5 h-2.5 text-blue-600" />
                                      <span>Submitted</span>
                                    </span>
                                  ) : (
                                    <span className="inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-md bg-amber-50 dark:bg-amber-950/40 border border-amber-300 dark:border-amber-800 text-amber-900 dark:text-amber-200 text-[8px] sm:text-[9px] font-bold">
                                ...
                                <div className="flex items-center justify-between sm:justify-end gap-2 sm:gap-3 shrink-0 text-right">
                                  <div className="text-left sm:text-right">
                                    ...
                                    <span className="font-bold text-neutral-900 dark:text-white text-[9px] sm:text-[10px] leading-tight block mt-0.5">
                                  ...
                                  <div className="text-left sm:text-right">
                                    ...
                                    <span className="font-bold text-emerald-600 dark:text-emerald-400 text-[9px] sm:text-[10px] leading-tight block mt-0.5">
                                  ...
                                  <div className="text-left sm:text-right">
                                    ...
                                    <span
                                      className={`font-bold text-[9px] sm:text-[10px] leading-tight block mt-0.5 ${
