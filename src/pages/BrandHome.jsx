    ...
    <div>
      ...
      <section className="site-container py-10">
        ...
        {loading ? (
          ...
          <div className="text-center py-12 rounded-none border border-dashed border-neutral-200 dark:border-neutral-800 text-neutral-400 bg-white/40 dark:bg-neutral-900/40">
          ...
          <>
            ...
            <motion.div
              ...
              className="hidden sm:grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 xl:grid-cols-5 2xl:grid-cols-6 3xl:grid-cols-6 4xl:grid-cols-6 gap-6"
            >
              {branches.map((br) => {
                const branchPhone = br.phone || br.contactNumber || br.contact || br.phoneNo;
                const detailUrl = `/brands/${brand.slug}/branches/${br.id || br._id}`;
