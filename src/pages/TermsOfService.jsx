...
export const TermsOfService = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950 text-neutral-800 dark:text-neutral-200 py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
        ...
        <div className="bg-white dark:bg-neutral-900 p-6 sm:p-8 rounded-3xl border border-neutral-200/80 dark:border-neutral-800/80 shadow-xs space-y-6 text-sm leading-relaxed">
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-neutral-900 dark:text-white flex items-center gap-2">
              <ShoppingBag className="w-5 h-5 text-primary-500" /> 1. Order Acceptance & Pricing
            </h2>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-neutral-900 dark:text-white flex items-center gap-2">
              <Truck className="w-5 h-5 text-primary-500" /> 2. Delivery & Fulfillment
            </h2>
            <p className="text-neutral-600 dark:text-neutral-400">
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold text-neutral-900 dark:text-white flex items-center gap-2">
              <RefreshCw className="w-5 h-5 text-primary-500" /> 3. Cancellations & Refunds
            </h2>
            <p className="text-neutral-600 dark:text-neutral-400">
